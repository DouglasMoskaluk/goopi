...
public class Explosion : SpawnableObject
{
    ...
    private IEnumerator Explode()
    {
        ...
        if (onExplosionSpawn != null) Instantiate(onExplosionSpawn, transform.position, transform.rotation, transform.parent).transform.localScale = transform.localScale;
