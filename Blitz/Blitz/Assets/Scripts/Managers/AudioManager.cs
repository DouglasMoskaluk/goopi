...
public class AudioManager : MonoBehaviour
{
    ...
    internal enum AudioQueue {
        ...
        */
        ...
        MEGA_OBLITERATED, ROULETTE_START, BUTTON_CANCEL,ROULETTE_STEPS, ROULETTE_JUMPS, 
        COLLISION_METAL, COLLISION_WOOD, SHROOM_BOUNCE, INTRO_LOGO, READY_UP, FIREWORK_BOOM, FIREWORK_HISS,
        CONFETTI_POP, BASKETBALL_GOAL, CROWN_VICTORY_ARRIVAL,
